...
CMD_ADDR = 82      # Calibration command register (1 WORD - 16-bit)
ACK_ADDR = 83      # Calibration ack register (1 WORD - 16-bit)
DATA_ADDR = 146    # sRmtCal.u32Data register (2 WORDS - 32-bit)
RETURN_ADDR = 148  # sRmtCal.u32Return register (2 WORDS - 32-bit)
